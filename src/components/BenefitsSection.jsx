    ...
    <section className="relative min-h-screen py-20 px-6 text-white overflow-hidden" style={{
      ...
      <div className="hidden lg:block absolute inset-0">
        <div className="relative w-full h-full max-w-6xl mx-auto">
          <div className="absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-lime-400 flex-shrink-0">
              <Shield className="w-5 h-5 text-gray-900" />
            </div>
            <span className="whitespace-nowrap text-sm font-medium pr-1">Top Security</span>
          </div>
          
          <div className="absolute top-1/3 left-20 -translate-y-1/2 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-purple-400 flex-shrink-0">
              <Zap className="w-5 h-5 text-gray-900" />
            </div>
            <span className="whitespace-nowrap text-sm font-medium pr-1">Fast Speed</span>
          </div>
          
          <div className="absolute top-1/3 right-20 -translate-y-1/2 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-700 flex-shrink-0">
              <CreditCard className="w-5 h-5 text-white" />
            </div>
            <span className="whitespace-nowrap text-sm font-medium pr-1">Fast Transactions</span>
          </div>
          
          <div className="absolute top-1/2 left-16 -translate-y-1/2 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-lime-400 flex-shrink-0">
              <Cloud className="w-5 h-5 text-gray-900" />
            </div>
            <span className="whitespace-nowrap text-sm font-medium pr-1">Cloud Sync</span>
          </div>
          
          <div className="absolute top-1/2 right-10 -translate-y-1/2 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-purple-400 flex-shrink-0">
              <Bell className="w-5 h-5 text-gray-900" />
            </div>
            <span className="whitespace-nowrap text-sm font-medium pr-1">Real-Time Alerts</span>
          </div>
          
          <div className="absolute bottom-24 left-40 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-purple-400 flex-shrink-0">
          ...
          <div className="absolute bottom-24 right-40 flex items-center gap-3 py-3 px-5 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-lime-400 flex-shrink-0">
      ...
      <div className="md:hidden absolute inset-0 px-2">
        <div className="relative w-full h-full">
          <div className="absolute top-4 left-2 flex items-center gap-2 py-2 px-3 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-lime-400 flex-shrink-0">
              <Shield className="w-4 h-4 text-gray-900" />
            </div>
            <span className="whitespace-nowrap text-xs font-medium">Top Security</span>
          </div>
          ...
          <div className="absolute top-4 right-2 flex items-center gap-2 py-2 px-3 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-purple-400 flex-shrink-0">
              <Zap className="w-4 h-4 text-gray-900" />
            </div>
            <span className="whitespace-nowrap text-xs font-medium">Fast Speed</span>
          </div>
          ...
          <div className="absolute top-20 left-2 flex items-center gap-2 py-2 px-3 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            ...
            <span className="whitespace-nowrap text-xs font-medium">Fast Transactions</span>
          </div>
          ...
          <div className="absolute top-20 right-2 flex items-center gap-2 py-2 px-3 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            ...
            <span className="whitespace-nowrap text-xs font-medium">Cloud Sync</span>
          </div>
          ...
          <div className="absolute bottom-24 left-2 flex items-center gap-2 py-2 px-3 rounded-full bg-gray-800/80 backdrop-blur-sm shadow-xl transition-all hover:scale-105 hover:bg-gray-800">
            ...
            <span className="whitespace-nowrap text-xs font-medium">Real-Time Alerts</span>
          </div>
